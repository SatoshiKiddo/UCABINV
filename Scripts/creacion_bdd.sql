...
CREATE TABLE Categoria_Uso (
	id_categoria_uso SERIAL,
	nombre VARCHAR(50) NOT NULL,
	
	PRIMARY KEY (id_categoria_uso)
);

CREATE TABLE Cita (
	id_cita SERIAL,
	id_direccion_uso INT,
	id_unidad_informacion INT NOT NULL,
	id_sub_titulo INT,
	id_categoria_uso INT NOT NULL,
	cita VARCHAR(1000) NOT NULL,
	delimitacion VARCHAR(200) NOT NULL,
	...
	CONSTRAINT fk_categoria_uso_cita FOREIGN KEY (id_categoria_uso) 
	REFERENCES categoria_Uso(id_categoria_uso) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE Contenido_Estructurado (
	id_contenido_estructurado SERIAL,
	id_cita INT NOT NULL,
	nombre VARCHAR(100) NOT NULL,
	contenido VARCHAR(1000) NOT NULL,
	
	
	PRIMARY KEY (id_contenido_estructurado),
	
	CONSTRAINT fk_cita_contenido_estructurado FOREIGN KEY (id_cita) 
	REFERENCES Cita(id_cita) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION
);

--ALTER TABLE Contenido_Estructurado
--DROP CONSTRAINT fk_cita_contenido_estructurado;

--ALTER TABLE Contenido_Estructurado
--ADD CONSTRAINT fk_cita_contenido_estructurado FOREIGN KEY (id_cita) 
--REFERENCES Cita(id_cita) MATCH SIMPLE
--ON UPDATE NO ACTION ON DELETE NO ACTION;

CREATE TABLE Contenido_Derivado (
	id_contenido_derivado SERIAL,
	id_contenido_estructurado INT NOT NULL,
	nombre VARCHAR(100) NOT NULL,
	contenido VARCHAR(800) NOT NULL,
	
	
	PRIMARY KEY (id_contenido_derivado),
	
	CONSTRAINT fk_contenido_estructurado_contenido_derivado FOREIGN KEY (id_contenido_estructurado) 
	REFERENCES Contenido_Estructurado(id_contenido_estructurado) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION
);

--ALTER TABLE Contenido_Derivado
--DROP CONSTRAINT fk_contenido_estructurado_contenido_derivado;

--ALTER TABLE Contenido_Derivado
--ADD CONSTRAINT fk_contenido_estructurado_contenido_derivado FOREIGN KEY (id_contenido_estructurado) 
--REFERENCES Contenido_Estructurado(id_contenido_estructurado) MATCH SIMPLE
--ON UPDATE NO ACTION ON DELETE NO ACTION;
...
CREATE TABLE Justificacion(
	...
	PRIMARY KEY (id_cita, id_tipo_argumentacion),
	
	CONSTRAINT fk_cita_justificacion FOREIGN KEY (id_cita) 
	REFERENCES Cita(id_cita) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE Contexto(
	id_contexto SERIAL,
	concepcion VARCHAR(300) NOT NULL,
...
CREATE TABLE Investigacion(
	...
	calidad INT,
	pregunta_investigacion VARCHAR(500) UNIQUE,
	...
	CONSTRAINT fk_temporalidad_investigacion FOREIGN KEY (id_temporalidad) 
	REFERENCES Temporalidad(id_temporalidad) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE TABLE Evento_Delimitado(
	id_evento_delimitado SERIAL,
	...
	PRIMARY KEY (id_evento_delimitado),
	
	CONSTRAINT fk_evento_evento_delimitado FOREIGN KEY (id_evento) 
	REFERENCES Evento(id_evento) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	
	CONSTRAINT fk_clase_evento_evento_delimitado FOREIGN KEY (id_clase_evento) 
	REFERENCES Clase_Evento(id_clase_evento) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	
	CONSTRAINT fk_abordaje_evento_delimitado FOREIGN KEY (id_abordaje) 
	REFERENCES Abordaje(id_abordaje) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	
	CONSTRAINT fk_tipo_evento_evento_delimitado FOREIGN KEY (id_tipo_evento) 
	REFERENCES Tipo_Evento(id_tipo_evento) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	
	CONSTRAINT fk_estadio_aplicado_evento_delimitado FOREIGN KEY (id_estadio_aplicado) 
	REFERENCES Estadio_Aplicado(id_estadio_aplicado) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION
);

ALTER TABLE Evento_Delimitado
DROP CONSTRAINT fk_clase_evento_evento_delimitado;

ALTER TABLE Evento_Delimitado
ADD CONSTRAINT fk_clase_evento_evento_delimitado FOREIGN KEY (id_clase_evento) 
REFERENCES Clase_Evento(id_clase_evento) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Evento_Delimitado
DROP CONSTRAINT fk_abordaje_evento_delimitado;

ALTER TABLE Evento_Delimitado
ADD CONSTRAINT fk_abordaje_evento_delimitado FOREIGN KEY (id_abordaje) 
REFERENCES Abordaje(id_abordaje) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Evento_Delimitado
DROP CONSTRAINT fk_tipo_evento_evento_delimitado;

ALTER TABLE Evento_Delimitado
ADD CONSTRAINT fk_tipo_evento_evento_delimitado FOREIGN KEY (id_tipo_evento) 
REFERENCES Tipo_Evento(id_tipo_evento) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Evento_Delimitado
DROP CONSTRAINT fk_estadio_aplicado_evento_delimitado;

ALTER TABLE Evento_Delimitado
ADD CONSTRAINT fk_estadio_aplicado_evento_delimitado FOREIGN KEY (id_estadio_aplicado) 
REFERENCES Estadio_Aplicado(id_estadio_aplicado) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
CREATE TABLE Sinergia(
	...
	id_evento_delimitado INT NOT NULL,
	nombre VARCHAR(100) NOT NULL,
	...
	CONSTRAINT fk_evento_delimitado_sinergia FOREIGN KEY (id_evento_delimitado) 
	REFERENCES Evento_Delimitado(id_evento_delimitado) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
ALTER TABLE Sinergia
DROP CONSTRAINT fk_evento_delimitado_sinergia;

ALTER TABLE Sinergia
ADD CONSTRAINT fk_evento_delimitado_sinergia FOREIGN KEY (id_evento_delimitado) 
REFERENCES Evento_Delimitado(id_evento_delimitado) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;
...
CREATE TABLE Indicio_Item (
	id_indicio_item SERIAL,
	id_item INT NOT NULL,
	id_indicio INT NOT NULL,
	
	PRIMARY KEY (id_item,id_indicio),
	
	CONSTRAINT fk_item_indicio_item FOREIGN KEY (id_item)
	REFERENCES Item(id_item) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION

);

ALTER TABLE Indicio_Item
DROP CONSTRAINT fk_item_indicio_item;

ALTER TABLE Indicio_Item
ADD CONSTRAINT fk_item_indicio_item FOREIGN KEY (id_item)
REFERENCES Item(id_item) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

CREATE TABLE Instrumento_Item (
	id_instrumento_item SERIAL,
	id_sinergia INT NOT NULL,
	id_instrumento INT NOT NULL,
	id_item INT NOT NULL,
	
	PRIMARY KEY (id_item,id_sinergia,id_instrumento),
	
	CONSTRAINT fk_aplicacion_instrumental_instrumento_item FOREIGN KEY (id_sinergia, id_instrumento)
	REFERENCES Aplicacion_Instrumental(id_sinergia, id_instrumento) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION,
	
	CONSTRAINT fk_item_instrumento_item FOREIGN KEY (id_item)
	REFERENCES Item(id_item) MATCH SIMPLE
	ON UPDATE NO ACTION ON DELETE NO ACTION

);

ALTER TABLE Instrumento_Item
DROP CONSTRAINT fk_aplicacion_instrumental_instrumento_item;

ALTER TABLE Instrumento_Item
ADD CONSTRAINT fk_aplicacion_instrumental_instrumento_item FOREIGN KEY (id_sinergia, id_instrumento)
REFERENCES Aplicacion_Instrumental(id_sinergia, id_instrumento) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Instrumento_Item
DROP CONSTRAINT fk_item_instrumento_item;

ALTER TABLE Instrumento_Item
ADD CONSTRAINT fk_item_instrumento_item FOREIGN KEY (id_item)
REFERENCES Item(id_item) MATCH SIMPLE
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Unidad_informacion DROP COLUMN fecha;
ALTER TABLE Unidad_Informacion ADD COLUMN fecha VARCHAR(50);