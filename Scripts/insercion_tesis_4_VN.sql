...
--Pedro, aqui puse los id de estadio aplicado como si fuesen eventos hehehe
...
(5, 1,3, 16, 20, 'Comparar los distintos algoritmos de aprendizaje'),
(3, 1,1, 17, 21,'Describir los mecanismos de orientación de los robots'),
(5, 1,3, 18, 22, 'Comparar la transmición de datos'),
(4, 1,4, 19, 23, 'Construir varios prototipos funcionales'),
(5, 1,2, 20, 24, 'Analizar los algoritmos de busqueda en conjunto'),
(5, 1,3, 21, 25, 'Comparar las distintas simulaciones'),
(10, 1,4, 20, 26, 'Definir una politica de seleccion de acciones'),
(10, 1,5, 16, 27, 'Manejo de la funcion de refuerzo'),
(5, 1,5, 18, 28, 'Diseño de la funcion de actualizacion de datos'),
(10, 1,5, 18, 29, 'Establecimiento de la forma de comunicación del sistema');
