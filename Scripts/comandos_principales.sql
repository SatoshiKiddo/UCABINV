...
SELECT * FROM Indicio_Item;

DROP TABLE Indicio_Item;

INSERT INTO Indicio_Item (id_item, id_indicio) 
	VALUES (1, 1);

DELETE FROM Indicio_Item;

SELECT * FROM Instrumento_Item;

DROP TABLE Instrumento_Item;

INSERT INTO Instrumento_Item (id_item, id_aplicacion_instrumental) 
	VALUES (1, 1);
